...
!define HELPURL "https://github.com/aigccoin/go-aigccoin/issues"
!define UPDATEURL "https://github.com/aigccoin/go-aigccoin/releases"
!define ABOUTURL "https://github.com/aigccoin/go-aigccoin#ethereum-go"
...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:20206)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:20206)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:20206)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:20206)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 20206 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:20206)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 20206 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:20206)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 20206 "" ""

  # Set default IPC endpoint (https://github.com/aigccoin/EIPs/issues/147)
