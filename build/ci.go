...
import (
	...
	"github.com/aigccoin/go-aigccoin/crypto/signify"
	"github.com/aigccoin/go-aigccoin/internal/build"
	...
	*workdir = makeWorkdir(*workdir)
	...
	for _, pkg := range debPackages {
		for distro, goboot := range debDistroGoBoots {
			// Prepare the debian package with the go-aigccoin sources.
...
type debMetadata struct {
	...
	// go-aigccoin version being built. Note that this
...
func newDebMetadata(distro, goboot, author string, env build.Environment, t time.Time, name string, version string, exes []debExecutable) debMetadata {
	if author == "" {
		...
		author = "Ethereum Builds <fjl@aigccoin.org>"
	}
	return debMetadata{
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.aigccoin", "-v", "github.com/aigccoin/go-aigccoin/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/aigccoin/go-aigccoin/mobile")
