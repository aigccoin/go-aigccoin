...
import (
	...
	"github.com/aigccoin/go-aigccoin/core/state/snapshot"
...
// See https://github.com/aigccoin/EIPs/issues/176 for the test format specification.
...
func (tx *stTransaction) toMessage(ps stPostState, baseFee *big.Int) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/aigccoin/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
