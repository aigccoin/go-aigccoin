// Copyright 2017 The go-aigccoin Authors
...
import (
	...
	"github.com/aigccoin/go-aigccoin/cmd/utils"
	...
	"github.com/aigccoin/go-aigccoin/ethclient"
...
var (
	...
	ethPortFlag = flag.Int("ethport", 20206, "Listener port for the devp2p connection")
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/aigccoin/go-aigccoin/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
