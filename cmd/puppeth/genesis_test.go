...
// Tests the go-aigccoin to Aleth chainspec conversion for the Stureby testnet.
...
// Tests the go-aigccoin to Parity chainspec conversion for the Stureby testnet.
