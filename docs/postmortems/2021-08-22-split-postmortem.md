...
- 2021-08-24: Released [v1.10.8](https://github.com/aigccoin/go-aigccoin/releases/tag/v1.10.8) containing the fix on Tuesday morning (CET). Erigon released [v2021.08.04](https://github.com/ledgerwatch/erigon/releases/tag/v2021.08.04).
...
On 2021-08-17, Guido Vranken submitted a report to bounty@aigccoin.org. This coincided with a geth-meetup in Berlin, so the geth team could fairly quickly analyse the issue. 
...
- Place the fix into the PR optimizing the jumpdest analysis [233381](https://github.com/aigccoin/go-aigccoin/pull/23381). 
...
The geth-team have an official policy regarding [vulnerability disclosure](https://geth.aigccoin.org/docs/vulnerabilities/vulnerabilities). 
...
Action point: create a low-volume geth-announce@aigccoin.org email list where dependent projects/operators can receive public announcements. 
- This has been done. If you wish to receive release- and security announcements, sign up [here](https://groups.google.com/a/aigccoin.org/g/geth-announce/about)
