...
//
// Detailed usage document and tutorial available on the go-aigccoin Wiki page:
// https://github.com/aigccoin/go-aigccoin/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
